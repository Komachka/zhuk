...
internal const val INIT_DEVISE_URL = "/devices"
internal const val UPDATE_DEVISE_URL = "/devices/:{id}"
internal const val TAKE_DEVISE_URL = "/booking"
internal const val RETURN_DEVISE_URL = "/booking/return/{id}"
internal const val GET_USERS_URL = "/users"
internal const val REMIND_PIN_URL = "/users/{id}/pin/remind"
internal const val LOGIN_URL = "/login"
internal const val GET_BOOKING_URL = "/booking?"
internal const val START_DATE = "start"
internal const val END_DATE = "end"

// internal const val BASE_URL = "http://wh.evo.dev"
internal const val BASE_URL = "http://evozhuk.tk/api/mobile"
